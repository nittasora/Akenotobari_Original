...
| --- | --- |
|  assets  |  素材フォルダ  |
|  assets/Editor  |  エディタ―用素材フォルダ  |
|  assets/Game  |  ゲーム用素材フォルダ  |
|  Game/Save  |  セーブデータ格納フォルダ  |
|  Game/Sound  |  音源素材フォルダ  |
|  Game/Sprits  |  画像素材フォルダ  |
|  Game/Stage  |  ステージデータ格納フォルダ  |
...
| --- | --- |
|   マウスカーソル  |  選択  |
|   左クリック  |  ボタン決定・選択・チップ追加・消去など  |
|   右クリック  |  ギミック選択中に同じギミックを右クリックでコンソール入力の設定画面を開く  |
|   マップチップ設置ボタン  |  ステージエディタ―へ  |
|   エディター用サンプルボタン  |  ゲーム画面へ  |
|   やめるボタン  |  終了  |
|   リクエスト作成ボタン  |  読み込み用データン作成  |
|   もどるボタン  |  エディタ―選択シーンへ  |
|   WORLD左右ボタン  |  ワールド変更  |
|   STAGE左右ボタン  |  ステージ変更  |
|   MAX左右ボタン  |  それぞれの最大数変更  |
|   画像追加ボタン  |  コンソール入力で画像の追加  |
|   スプライト設定ボタン  |  コンソール入力で画像の設定変更  |
|   マップチップボタン  |  マップチップ選択  |
|   背景ボタン  |  背景画像選択  |
|   とばりちゃんボタン  |  コンソール入力でプレイヤーの位置変更  |
|   ギミックボタン  |  ギミック選択  |
|   表・裏ボタン  |  ステージの表裏切り替え  |
|   右下矢印ボタン  |  マップチップを右回転  |
|   左下矢印ボタン  |  マップチップを左回転  |
