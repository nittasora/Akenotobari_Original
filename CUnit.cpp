...
void CUnit::Initilize()
{
}

void CUnit::UnInitilize()
{
}

void CUnit::FakeFoldDraw()
{
...
void CUnit::SetAxis(const Translate * new_axis)
{
	this->m_axis = *new_axis;
}

void CUnit::SetFoldAngle(float new_angle)
{
	this->mf_fold_angle_y = new_angle;
}

void CUnit::SetNotRotate(bool not_rotate)
{
	this->mb_not_rotate = not_rotate;
}

void CUnit::InitilizeFold()
{
	this->m_axis.x = 0.0f;
	this->m_axis.y = 0.0f;
	this->m_axis.z = 0.0f;
	this->mf_fold_angle_y = 0.0f;
	this->mb_not_rotate = false;
}

bool CUnit::GetGroundFlg()
{
	return this->mb_is_ground;
}
